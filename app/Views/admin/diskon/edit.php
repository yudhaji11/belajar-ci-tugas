    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Form Edit Data Diskon</h5>
                        <form action="<?= base_url('admin/diskon/' . $diskon['id']); ?>" method="post">
                            <?= csrf_field(); ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control <?= ($validation->hasError('nominal')) ? 'is-invalid' : ''; ?>" id="nominal" name="nominal" value="<?= old('nominal', $diskon['nominal']); ?>">
